...
public class BlockCtrl : SaiMonoBehaviour
{
    ...
    {
        this.sprite = sprite;
        Vector2 oldSpriteSize = spriteRender.sprite.bounds.size;
        this.spriteRender.sprite = sprite;
        Vector2 newSpriteSize = spriteRender.sprite.bounds.size;
        Vector3 scale = spriteRender.transform.localScale;
        scale.x *= oldSpriteSize.x / newSpriteSize.x;
        scale.y *= oldSpriteSize.y / newSpriteSize.y;
